...
public class Assignment3_DuplicateLead {
	public static void main(String[] args) {
		...
		WebElement company_dup = driver.findElement(By.id("createLeadForm_companyName"));

		company_dup.clear();
		company_dup.sendKeys("companyA");
		WebElement FirstName_dup = driver.findElement(By.id("createLeadForm_firstName"));

		FirstName_dup.clear();
		FirstName_dup.sendKeys("FA");

		WebElement createLead_dup = driver.findElement(By.xpath("//input[@name='submitButton']"));
		createLead_dup.click();
